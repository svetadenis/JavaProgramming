...
public class Pizza {
    public char size;//instance variable, can be multiple copies
    ...
    public void setInfo(char size, int numberOfCheeseTopping, int numberOfPepperoni){
       this.size=size;
       this.numberOfCheeseTopping = numberOfCheeseTopping;
       this.numberOfPepperoniTopping = numberOfPepperoni;
   ...
   public String toString() {
        return "Pizza{" +
                ...
                ", total price=" + calcCost() +//we added this line manually
                '}';
    }
}
