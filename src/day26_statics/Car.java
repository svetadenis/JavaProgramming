...
public class Car {
   //we declared all these variables as instance variables
    //it's mean we can create multiple car objects,we'll be able to store different data in these objects
    //instance means it belongs to the object. each object has his own memory
