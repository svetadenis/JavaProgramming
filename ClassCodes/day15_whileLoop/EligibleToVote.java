...
public class EligibleToVote {
    ...
    while(!(age>=1 && age<=120)){//while the age is not valid
        ...
        while(!(yesOrNo.equals("yes") || yesOrNo.equals("no") )){//while the answer is neither yes nor no we ask to person to re-enter
        System.out.println("Invalid Entry! Please re-enter");
        System.out.println("Are you the US citizen? Yes/No");
