...
public class WarmupTasks {
    ...
    calculate (n1,n2,operator);
        ...
        ageGroup(75);//Senior, we called a method from Task2
        System.out.println("_____________________________________________");

        eligibleToVote(35,false);//You are not eligible to vote.
        //We called the method from Task3
    }
    //Method for tasks1
...
1. Create a method named calculate that can take three arguments:
	    ...
	    as long as the 3rd argument is a valid math operator,
